...
@section('breadcrumb')
	<ol class="breadcrumb">
	  <li><a href="{{ url('area/dashboard') }}"><i class="fa fa-dashboard" aria-hidden="true"></i> Escritorio</a></li>
...
<div class="content">
	<section>
		<a class="btn btn-flat btn-default" href="{{ url('area/dashboard') }}"><i class="fa fa-reply"></i> Volver</a>
	</section>
        ...
        <h2 class="page-header" style="margin-top:0!important">
          ...
          {{$perfil->detalles->nombres." ".$perfil->detalles->apellidos}}
			  ...
			  <form action="{{route('update_perfil')}}" method="POST" id="editar">
				  ...
				  <feildset id="pass" style="display:none" disabled>
					  <div class="form-group col-md-4 col-md-offset-4">
