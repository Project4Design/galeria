			...
			<div class="col-md-6 col-md-offset-3">
				<form class="" action="{{ url($url) }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group {{ $errors->has('nombres')?'has-error':'' }}">
						...
						<input id="nombres" class="form-control" type="text" name="nombres" value="{{ old('nombres')?old('nombres'):$estudiante->nombres }}" placeholder="Nombres">
					</div>
					...
					<div class="form-group {{ $errors->has('email')?'has-error':'' }}">
						...
						<input id="email" class="form-control" type="text" name="email" value="{{ old('email')?old('email'):$estudiante->email }}" placeholder="Email">
					</div>
					...
					<div class="form-group {{ $errors->has('tlf_personal')?'has-error':'' }}">
						...
						<input id="tlf_personal" class="form-control" type="text" name="tlf_personal" value="{{ old('tlf_personal')?old('tlf_personal'):$estudiante->tlf_personal }}" placeholder="Telefono personal">
					</div>
